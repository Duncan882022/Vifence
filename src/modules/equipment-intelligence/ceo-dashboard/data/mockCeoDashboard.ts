...
export const CEO_DASHBOARD_MOCK: CeoDashboardData = {
  ...
  regions: [
    // x% = svg_x/200*100, y% = svg_y/400*100 (viewBox 0 0 200 400)
    { id: 'quang-ninh', name: 'Quảng Ninh',          machineCount: 260, x: 74, y: 7  },
    { id: 'ha-noi',     name: 'Hà Nội',               machineCount: 150, x: 53, y: 16 },
    { id: 'vung-ang',   name: 'Hà Tĩnh / Vũng Áng',  machineCount: 180, x: 46, y: 31 },
    { id: 'da-nang',    name: 'Đà Nẵng / Hải Vân Bay',machineCount: 148, x: 48, y: 41 },
    { id: 'can-gio',    name: 'Cần Giờ (HCM)',        machineCount: 80,  x: 61, y: 72 },
    { id: 'long-an',    name: 'Long An',               machineCount: 72,  x: 49, y: 76 },
  ],
  usageUnits: [
  ...
  aiRecommendations: [
    {
      ...
      detail: 'Kiểm tra cốc lọc và vệ sinh lọc nhiên liệu',
      riskScorePct: 82,
      ruleId: 'DIAG-006',
      confidencePct: 87,
