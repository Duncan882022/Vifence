        ...
        <div className="max-w-2xl mx-auto w-full space-y-4 pb-8">
          ...
          <div className="text-center space-y-2 pt-2 sm:pt-4">
            ...
            <p className="text-[11px] text-muted-foreground leading-relaxed px-2">
              Bước 1: Quét 3 góc mặt · Bước 2: Nhập họ tên, mã nhân viên và đơn vị.
            </p>
          </div>
      ...
      {adminStep === 'lookup' && (
        <div className="max-w-lg mx-auto w-full space-y-4">
          <div className="text-center space-y-2 pt-4">
            ...
            <p className="text-[11px] text-muted-foreground leading-relaxed px-2">
              Tra cứu mã đã có để bổ sung vector, hoặc tạo hồ sơ mới kèm quét 3 góc.
            </p>
          </div>
          ...
          <Panel title="Tạo hồ sơ mới" className="overflow-visible">
            <div className="p-4 space-y-3">
              <p className="text-[10px] text-muted-foreground leading-relaxed">
                Chưa có mã trong hệ thống? Tạo hồ sơ mới: quét 3 góc mặt rồi nhập họ tên, mã nhân viên và đơn vị.
