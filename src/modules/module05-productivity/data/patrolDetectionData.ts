...
const ZONE_DETECTION_CONFIG: ZoneDetectionConfig[] = [
  { zoneId: 'ZONE_1', personCount: 4, vehicleCount: 2, equipmentCount: 1, cameras: ['HC-01'] },
  { zoneId: 'ZONE_2', personCount: 6, vehicleCount: 2, equipmentCount: 1, cameras: ['HC-01'] },
  { zoneId: 'ZONE_3', personCount: 8, vehicleCount: 3, equipmentCount: 1, cameras: ['HC-01', 'HC-02'] },
  { zoneId: 'ZONE_4', personCount: 5, vehicleCount: 2, equipmentCount: 0, cameras: ['HC-02'] },
  { zoneId: 'ZONE_5', personCount: 6, vehicleCount: 2, equipmentCount: 0, cameras: ['HC-02'] },
  { zoneId: 'ZONE_6', personCount: 4, vehicleCount: 1, equipmentCount: 0, cameras: ['HC-02'] },
]
...
export const DETECTION_DOT_OPACITY_IN_VIEW = 1
export const DETECTION_DOT_OPACITY_OUT_OF_VIEW = 0.62
