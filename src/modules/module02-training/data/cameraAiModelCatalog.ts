...
export const CAMERA_AI_MODEL_CATALOG: CameraAiModelDefinition[] = [
  ...
  },
  {
    ...
    label: 'Lòng đường',
    groupId: 'BPTC',
    scenarioIds: ['BPTC-007', 'BPTC-008', 'BPTC-009'],
    description: 'Bùn, nước đọng, vật cản. Auto-train road_material v3.',
    needsPolygon: true,
    polygonHint: 'Vẽ ROAD (+ BUFFER tùy chọn).',
    endpoint: '/analyze/road/frame',
    autoTrainTasks: ['road_material'],
    overlayKind: 'road',
    modelVersion: 'v3',
    modelMetric: 'mAP50 0.82',
  ...
  },
  {
    ...
    overlayKind: 'crane',
    videoSegments: [
      { startSec: 0, endSec: 9.8 },
      { startSec: 24.95, endSec: 9999 },
    ],
    modelVersion: 'v4',
  ...
  },
  {
    ...
    overlayKind: 'ppe',
    videoSegments: [{ startSec: 0, endSec: 19.95 }],
    modelVersion: 'v2',
