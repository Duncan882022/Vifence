...
/** Ngưỡng overlay HC-02 — khớp BE person_conf=0.12 (vàng nếu <0.28). */
const HC02_PERSON_MIN_CONF = 0.12
const HC02_PERSON_STRONG_CONF = 0.28
        ...
        const minConf = (d: MobileAiDetection) => {
          if (isPatrolCam) {
            if (d.behavior === 'person') {
              return d.confidence >= (cameraId === 'HC-02' ? HC02_PERSON_MIN_CONF : 0.12)
            }
            return false
          }
